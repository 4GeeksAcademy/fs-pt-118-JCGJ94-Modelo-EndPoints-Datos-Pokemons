...
# get all pokemons AND get one pokemon by id
...
# get all items AND get one item by id
...
# get all favorites and get favorites by user_id, create favorite and delete favorite
